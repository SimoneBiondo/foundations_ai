...
class CSP_QueenProblem:
    ...
    def initialize_state(self):
        ...
        # Inferences help detect future failures by
        # keeping track of the current domain of available
        # values ​​for each variable. This is done by using a
        # set of values ​​that have been removed from the domain.
        inferences = {}
        ...
        return {
            ...
            'unassigned_queens': unassigned_queens,
            'inferences': inferences
        }
    
    def domain(self, variable, assignment):
    ...
    def neighbors(self, variable, assignment):
        return list(filter(lambda q: q != variable, assignment['unassigned_queens']))

    def exist_consistent(self, value, domain):
        for q in domain:
